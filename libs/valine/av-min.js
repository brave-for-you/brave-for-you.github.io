  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      var r = n(3),
        ...
        p = function (t, e) {
          e
            ? (t["X-LC-Sign"] = h(c.applicationKey))
            : (t["X-LC-Key"] = c.applicationKey);
        },
        v = function () {
          var t =
          ...
          return (
            "boolean" == typeof t.useMasterKey
              ? (r = t.useMasterKey)
              : "boolean" == typeof c._config.useMasterKey &&
                (r = c._config.useMasterKey),
            r
              ? c.masterKey
                ? e
                  ? (n["X-LC-Sign"] = h(c.masterKey, !0))
                  : (n["X-LC-Key"] = c.masterKey + ",master")
                : (console.warn(
            ...
            null !== c._config.production &&
              (n["X-LC-Prod"] = String(c._config.production)),
        ...
        b = function (t) {
          ...
          var h = c._config.requestTimeout,
            p = _({ service: e, path: i, version: n });
          return v(u, l).then(function (t) {
            return d({
              ...
              (e.rawMessage = e.rawMessage || e.error),
                c._sharedConfig.keepErrorRawMessage ||
                  (e.error +=
                    " [" + (t.statusCode || "N/A") + " " + r + " " + p + "]");
        ...
        y = function (t, e, n, r, i, o, s) {
          ...
          return (
            r && "get" === r.toLowerCase() && ((s = u({}, s, i)), (i = null)),
            b({ method: r, path: a, query: s, data: i, authOptions: o })
          );
        };
      (c.request = b), (t.exports = { _request: y, request: b });
    },
    function (t, e, n) {
      "use strict";
      var r = n(5),
    ...
    function (t, e, n) {
      ...
      var i = n(3),
        ...
        y = function (t, e) {
          for (
            var n = e.split("."), r = n[0], i = n.pop(), o = t, s = 0;
            s < n.length;
            s++
          )
    ...
    function (t, e, n) {
      var r = n(6),
        ...
        u = function (t, e, n) {
          ...
          h && (n = e);
          for (c in n)
            ((f = !d && g && void 0 !== g[c]) && a(y, c)) ||
              ((l = f ? g[c] : n[c]),
              (y[c] =
                h && "function" != typeof g[c]
                  ? n[c]
                  : _ && f
                    ? o(l, r)
                    : b && g[c] == l
    ...
    function (t, e, n) {
      ...
      function r(t, e, n) {
        e = Object(i.a)(e, n);
        var r, a;
        if (Object(o.a)(t)) for (r = 0, a = t.length; r < a; r++) e(t[r], r, t);
        else {
          var u = Object(s.a)(t);
    ...
    function (t, e, n) {
      ...
      function r(t, e, n) {
        e = Object(i.a)(e, n);
        for (
          var r = !Object(o.a)(t) && Object(s.a)(t),
            a = (r || t).length,
            u = Array(a),
            c = 0;
          c < a;
    ...
    function (t, e, n) {
      ...
      (function (e) {
        ...
        (g._sharedConfig = { userAgent: O, liveQueryRealtime: null }),
          ...
          (g._encode = function (t, e, n) {
            ...
            if (t instanceof g.Object) {
              ...
              return e && !f.include(e, t) && t._hasData
                ? t._toFullJSON(e.concat(t), r)
                : t._toPointer();
            }
          ...
          (g._traverse = function (t, e, n) {
            ...
            return t instanceof g.Relation || t instanceof g.File
              ? e(t)
              : f.isArray(t)
          ...
          (g._objectEach = g._each =
            function (t, e) {
              f.isObject(t)
                ? f.each(f.keys(t), function (n) {
                    e(t[n], n);
                  })
                : f.each(t, e);
            }),
    ...
    function (t, e, n) {
      ...
      var r = n(9),
        ...
        s = Object(r.a)(function (t, e) {
          var n = s.placeholder,
            r = function () {
              for (var o = 0, s = e.length, a = Array(s), u = 0; u < s; u++)
                a[u] = e[u] === n ? arguments[o++] : e[u];
    ...
    function (t, e, n) {
      ...
      var i = n(19),
        ...
        y = function (t) {
          ...
          var g = _("request"),
            O = g(n, { method: e, headers: u, data: i, onprogress: v })
              .then(function (t) {
                if (
                  (h(
                    "response(%d) %d %O %o",
                ...
                throw (
                  (t.response &&
                    (d.enabled("leancloud:request") ||
                      p("request(%d) %s %s %o %o %o", m, e, n, r, i, u),
                    p(
                      "response(%d) %d %O %o",
                      m,
                      t.response.status,
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, p, v, _, b) {
        ...
        if (
          (T &&
            (g = f(T.call(new t()))) !== Object.prototype &&
            g.next &&
            (c(g, w, !0), r || "function" == typeof g[l] || s(g, l, h)),
          j &&
            E &&
            "values" !== E.name &&
            ((A = !0),
    ...
    function (t, e, n) {
      ...
      function r(t) {
        return i.l
          ...
          : Object(a.a)(t) && u.test(i.t.call(t));
      }
      var i = n(1),
        o = n(76),
        s = n(117),
    ...
    function (t, e, n) {
      ...
      function i(t, e) {
        ...
        var n = o.n.length,
          ...
          c = "constructor";
        for (Object(a.a)(t, c) && !e.contains(c) && e.push(c); n--; )
    ...
    function (t, e, n) {
      ...
      function r(t) {
        return function (e, n, r) {
          n = Object(i.a)(n, r);
          for (
            var s = Object(o.a)(e), a = t > 0 ? 0 : s - 1;
            a >= 0 && a < s;
            a += t
          )
    ...
    function (t, e, n) {
      ...
      function r(t, e, n) {
        return function (r, a, u) {
          ...
          if (a !== a)
            return (u = e(o.q.call(r, c, f), s.a)), u >= 0 ? u + c : -1;
    ...
    function (t, e, n) {
      ...
      function r(t, e, n) {
        if (null == e || n)
          return (
            Object(i.a)(t) || (t = Object(s.a)(t)), t[Object(u.a)(t.length - 1)]
          );
    ...
    function (t, e, n) {
      ...
      e.a = Object(r.a)(function (t, e) {
        ...
        if (null == t) return n;
        Object(i.a)(r)
          ? (e.length > 1 && (r = Object(o.a)(r, e[1])), (e = Object(s.a)(t)))
      ...
      function r(t, e, n, r) {
        ...
        for (var u = [], c = [], f = 0, l = Object(s.a)(t); f < l; f++) {
          ...
          e && !n
            ? ((f && c === h) || u.push(d), (c = h))
            : n
              ? Object(a.a)(c, h) || (c.push(h), u.push(d))
              : Object(a.a)(u, d) || u.push(d);
        }
        return u;
      }
      e.a = r;
    ...
    function (t, e, n) {
      t.exports = { default: n(267), __esModule: !0 };
    },
    function (t, e, n) {
      function r(t, e, n) {
        var r = (e && n) || 0;
    ...
    function (t, e, n) {
      ...
      (e.getAsync = function (t) {
        ...
        (e.setAsync = function (t, e, n) {
          var r = { value: e };
          return (
            "number" == typeof n && (r.expiredAt = Date.now() + n),
    ...
    function (t, e, n) {
      t.exports = { default: n(308), __esModule: !0 };
    },
    function (t, e) {
      var n = {
        utf8: {
        ...
        return (i =
          ...
          "symbol" === (0, c.default)(a.default)
            ...
            : function (t) {
                return t &&
                  "function" == typeof l.default &&
                  t.constructor === l.default &&
                  t !== l.default.prototype
                  ? "symbol"
                  : void 0 === t
                    ? "undefined"
                    : (0, c.default)(t);
    ...
    function (t, e, n) {
      ...
      function r(t) {
        ...
        return "number" == typeof e &&
          (Object(o.a)(t) || Object(s.a)(t) || Object(a.a)(t))
          ? 0 === e
    ...
    function (t, e, n) {
      ...
      function i(t, e, n, o) {
        t instanceof s.a && (t = t._wrapped),
          e instanceof s.a && (e = e._wrapped);
        var b = a.t.call(t);
        ...
        if ((n.push(t), o.push(e), y)) {
          ...
          for (; O--; )
            if (((w = j[O]), !Object(p.a)(e, w) || !r(t[w], e[w], n, o)))
              return !1;
        }
      ...
      function r(t, e, n) {
        var r,
          ...
          f = function () {
            ...
            e > i
              ? (r = setTimeout(f, e - i))
              : ((r = null), n || (u = t.apply(c, a)), r || (a = c = null));
          },
          l = Object(i.a)(function (i) {
            return (
              ...
              (a = i),
              (s = Object(o.a)()),
              r || ((r = setTimeout(f, e)), n && (u = t.apply(c, a))),
              u
            );
          });
        return (
    ...
    function (t, e, n) {
      ...
      function r(t, e, n) {
        e = Object(i.a)(e, n);
        for (
          var r = !Object(o.a)(t) && Object(s.a)(t), a = (r || t).length, u = 0;
          u < a;
          u++
        ) {
          var c = r ? r[u] : u;
      ...
      e.a = Object(r.a)(function (t, e) {
        ...
        return (
          Object(i.a)(r)
            ...
            : ((e = Object(s.a)(Object(a.a)(e, !1, !1), String)),
              (r = function (t, n) {
    ...
    function (t, e, n) {
      ...
      function r(t) {
        for (
          var e = [], n = arguments.length, r = 0, s = Object(i.a)(t);
          r < s;
          r++
        ) {
          var a = t[r];
    ...
    function (t, e, n) {
      ...
      function r(t) {
        return (
          Object(o.a)(Object(s.a)(t), function (e) {
            var n = (i.a[e] = t[e]);
            i.a.prototype[e] = function () {
              var t = [this._wrapped];
              return (
                a.o.apply(t, arguments), Object(u.a)(this, n.apply(i.a, t))
              );
            };
          }),
          i.a
      ...
      Object(i.a)(
        ...
        Object(i.a)(["concat", "join", "slice"], function (t) {
          ...
          r.a.prototype[t] = function () {
            var t = this._wrapped;
            return (
              null != t && (t = e.apply(t, arguments)), Object(s.a)(this, t)
            );
          };
        }),
        (e.a = r.a);
    ...
    function (t, e, n) {
      ...
      (s.init = function (t) {
        ...
        if (
          ...
          p(e) && !y && h(s._config.serverURLs))
        )
          throw new TypeError(
            "serverURL option is required for apps from CN region",
          );
        e !== s._config.applicationId
          ? ((s._config.masterKey = i), (s._config.hookKey = o))
          : (i && (s._config.masterKey = i), o && (s._config.hookKey = o)),
          (s._config.applicationId = e),
          (s._config.applicationKey = n),
          c(g) || s.setProduction(g),
          void 0 !== m && (s._config.disableCurrentUser = m);
        var w = _ || void 0 !== y;
        if (
          (w || (s._appRouter = new a(s)),
          s._setServerURLs(
            l({}, r(e), s._config.serverURLs, "string" == typeof y ? v(y) : y),
            w,
          ),
          O)
        )
          s._config.realtime = O;
        ...
        (s.setProduction = function (t) {
          c(t)
            ? (s._config.production = null)
            : (s._config.production = t ? 1 : 0);
        }),
        (s._setServerURLs = function (t) {
          var e =
            !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
          "string" != typeof t
            ? l(s._config.serverURLs, t)
            : (s._config.serverURLs = v(t)),
            e && (s._appRouter ? s._appRouter.disable() : (_ = !0));
        }),
    ...
    function (t, e, n) {
      ...
      var r = n(6),
        ...
        $ = function (t, e) {
          y(t);
          for (var n, r = _((e = O(e))), i = 0, o = r.length; o > i; )
            H(t, (n = r[i++]), e[n]);
          return t;
        },
        X = function (t, e) {
        ...
        Y = function (t) {
          ...
          return (
            !(this === B && i(F, t) && !i(W, t)) &&
            (!(e || !i(this, t) || !i(F, t) || (i(this, D) && this[D][t])) || e)
          );
        },
        Z = function (t, e) {
          if (((t = O(t)), (e = w(e, !0)), t !== B || !i(F, e) || i(W, e))) {
            var n = N(t, e);
            return (
              !n || !i(F, e) || (i(t, D) && t[D][e]) || (n.enumerable = !0), n
            );
          }
        },
        tt = function (t) {
          for (var e, n = I(O(t)), r = [], o = 0; n.length > o; )
            i(F, (e = n[o++])) || e == D || e == u || r.push(e);
          return r;
        },
        et = function (t) {
          for (
            var e, n = t === B, r = I(n ? W : O(t)), o = [], s = 0;
            r.length > s;
      ...
      Q ||
        ((k = function () {
          ...
          return o && z && K(B, t, { configurable: !0, set: e }), J(t);
        }),
        ...
        (n(93).f = Y),
        (C.f = et),
        o && !n(40) && a(B, "propertyIsEnumerable", Y, !0),
        (p.f = function (t) {
          return J(h(t));
        })),
      ...
      s(s.S + s.F * st, "Object", {
        ...
        k.prototype[M] || n(23)(k.prototype, M, k.prototype.valueOf),
        l(k, "Symbol"),
        l(Math, "Math", !0),
        l(r.JSON, "JSON", !0);
    },
        ...
        (t.Events = {
          ...
          trigger: function (t) {
            ...
            for (
              ...
              if ((i = u))
                for (s = i.tail, a = [r].concat(c); (i = i.next) !== s; )
      ...
      t.exports = function (t) {
        ...
        (t.File = function (n, i, s) {
          ...
          o.extend(t.File.prototype, {
            ...
            destroy: function (t) {
              return this.id
                ? f("files", null, this.id, "DELETE", null, t)
            ...
            fetch: function (t, e) {
              ...
              return f("files", null, this.id, "GET", h(t), e).then(
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n) {
        ...
        return (
          o("url: %s, file: %o, options: %o", s, a, u),
          i("upload")(s, a, u).then(
            function (e) {
    ...
    function (t, e, n) {
      ...
      function i(t, e, n) {
        var r =
          ...
          s = { field: "file", data: e, name: n.attributes.name },
          a = {
            headers: n._uploadHeaders,
        ...
        return (
          S("url: %s, file: %o, options: %o", o, s, a),
          A("upload")(o, s, a).then(
            function (e) {
      ...
      var a = n(160),
        ...
        T = (function () {
          function t(e, n, r, i) {
            ...
            (this.baseURL =
              u + "/buckets/" + e.bucket + "/objects/" + a + "/uploads"),
              ...
              i &&
                ...
                (this.onProgress = function (t) {
                  var e = t.loaded;
                  (e += s.uploadedChunks * x) <= s.uploaded ||
                    (s.size
                      ? i.onprogress({
                          loaded: e,
                          total: s.size,
        ...
        N = (function (t) {
          function e(t, n, r, i) {
            ...
            var o = (0, f.default)(
              this,
              (e.__proto__ || (0, u.default)(e)).call(this, t, n, r, i),
            );
      ...
      t.exports = function (t, e, n) {
        var r =
          arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
        return s(e) && e.size >= 67108864
          ? new N(t, e, n, r).upload()
          : i(t, e, n, r);
      };
    },
    function (t, e, n) {
          ...
          ("__proto__" in {}
            ? (function (t, e, r) {
                try {
                  (r = n(31)(
                    Function.call,
                    n(94).f(Object.prototype, "__proto__").set,
                    2,
                  )),
                    r(t, []),
        ...
        var e = n(313),
          ...
          s = function (t, n) {
            ...
            (a[u >>> 5] |= 128 << u % 32),
              (a[14 + (((u + 64) >>> 9) << 4)] = u);
            for (
              var p = s._ff, v = s._gg, _ = s._hh, b = s._ii, h = 0;
              h < a.length;
              h += 16
            ) {
              var y = c,
              ...
              (c = p(c, f, l, d, a[h + 0], 7, -680876936)),
                ...
                (c = v(c, f, l, d, a[h + 1], 5, -165796510)),
                (d = v(d, c, f, l, a[h + 6], 9, -1069501632)),
                (l = v(l, d, c, f, a[h + 11], 14, 643717713)),
                (f = v(f, l, d, c, a[h + 0], 20, -373897302)),
                (c = v(c, f, l, d, a[h + 5], 5, -701558691)),
                (d = v(d, c, f, l, a[h + 10], 9, 38016083)),
                (l = v(l, d, c, f, a[h + 15], 14, -660478335)),
                (f = v(f, l, d, c, a[h + 4], 20, -405537848)),
                (c = v(c, f, l, d, a[h + 9], 5, 568446438)),
                (d = v(d, c, f, l, a[h + 14], 9, -1019803690)),
                (l = v(l, d, c, f, a[h + 3], 14, -187363961)),
                (f = v(f, l, d, c, a[h + 8], 20, 1163531501)),
                (c = v(c, f, l, d, a[h + 13], 5, -1444681467)),
                (d = v(d, c, f, l, a[h + 2], 9, -51403784)),
                (l = v(l, d, c, f, a[h + 7], 14, 1735328473)),
                (f = v(f, l, d, c, a[h + 12], 20, -1926607734)),
                (c = _(c, f, l, d, a[h + 5], 4, -378558)),
                (d = _(d, c, f, l, a[h + 8], 11, -2022574463)),
                (l = _(l, d, c, f, a[h + 11], 16, 1839030562)),
                (f = _(f, l, d, c, a[h + 14], 23, -35309556)),
                (c = _(c, f, l, d, a[h + 1], 4, -1530992060)),
                (d = _(d, c, f, l, a[h + 4], 11, 1272893353)),
                (l = _(l, d, c, f, a[h + 7], 16, -155497632)),
                (f = _(f, l, d, c, a[h + 10], 23, -1094730640)),
                (c = _(c, f, l, d, a[h + 13], 4, 681279174)),
                (d = _(d, c, f, l, a[h + 0], 11, -358537222)),
                (l = _(l, d, c, f, a[h + 3], 16, -722521979)),
                (f = _(f, l, d, c, a[h + 6], 23, 76029189)),
                (c = _(c, f, l, d, a[h + 9], 4, -640364487)),
                (d = _(d, c, f, l, a[h + 12], 11, -421815835)),
                (l = _(l, d, c, f, a[h + 15], 16, 530742520)),
                (f = _(f, l, d, c, a[h + 2], 23, -995338651)),
                (c = b(c, f, l, d, a[h + 0], 6, -198630844)),
                (d = b(d, c, f, l, a[h + 7], 10, 1126891415)),
                (l = b(l, d, c, f, a[h + 14], 15, -1416354905)),
                (f = b(f, l, d, c, a[h + 5], 21, -57434055)),
                (c = b(c, f, l, d, a[h + 12], 6, 1700485571)),
                (d = b(d, c, f, l, a[h + 3], 10, -1894986606)),
                (l = b(l, d, c, f, a[h + 10], 15, -1051523)),
                (f = b(f, l, d, c, a[h + 1], 21, -2054922799)),
                (c = b(c, f, l, d, a[h + 8], 6, 1873313359)),
                (d = b(d, c, f, l, a[h + 15], 10, -30611744)),
                (l = b(l, d, c, f, a[h + 6], 15, -1560198380)),
                (f = b(f, l, d, c, a[h + 13], 21, 1309151649)),
                (c = b(c, f, l, d, a[h + 4], 6, -145523070)),
                (d = b(d, c, f, l, a[h + 11], 10, -1120210379)),
                (l = b(l, d, c, f, a[h + 2], 15, 718787259)),
                (f = b(f, l, d, c, a[h + 9], 21, -343485551)),
                (c = (c + y) >>> 0),
                (f = (f + m) >>> 0),
                (l = (l + g) >>> 0),
                (d = (d + O) >>> 0);
      ...
      t.exports = function (t) {
        (t.Object = function (e, n) {
              ...
              .then(function (e) {
                var n = h.map(t, function (t, n) {
                  ...
                  return null === e[n].success
                    ? new p(p.OBJECT_NOT_FOUND, "Object not found.")
                    : new p(e[n].error.code, e[n].error.error);
                });
                return x(n);
              });
          }),
          h.extend(t.Object.prototype, t.Events, {
            ...
            _toFullJSON: function (e) {
              ...
              return (
                ...
                h.has(this, "id") && (i.objectId = this.id),
                ["createdAt", "updatedAt"].forEach(function (t) {
                  if (h.has(n, t)) {
                    var e = n[t];
                ...
                r &&
                  ((i.__type = "Object"),
                  h.isArray(e) && e.length && (i.__type = "Pointer"),
                ...
                t._arrayEach(this._opSetQueue, function (r) {
                  ...
                  if (i) {
                    var o = w(n.attributes, e),
                      ...
                      c = s[2],
                      l = s[3];
                    O(n.attributes, e, i._estimate(a, n, e)),
                      u && u[c] === t.Op._UNSET && delete u[c],
            ...
            _rebuildAllEstimatedData: function () {
              ...
              (this.attributes = h.clone(this._serverData)),
            ...
            set: function (e, n, r) {
              ...
              if (
                (h.isObject(e) || y(e)
                  ? ((i = h.mapObject(e, function (e, n) {
                      return C(n), t._decode(e, n);
                    })),
                    (r = n))
                  : ((i = {}), C(e), (i[e] = t._decode(n, e))),
                (r = r || {}),
                !i)
              )
                return this;
              ...
              t._objectEach(o, function (e, n) {
                e instanceof t.Op &&
                  ((o[n] = e._estimate(s.attributes[n], s, n)),
              ...
              return (
                t._arrayEach(h.keys(i), function (e) {
                  ...
                  (u[e] = n._mergeWithPrevious(u[e])),
                    ...
                    o
                      ? ((s.changed[e] = s.attributes[e]),
                        r.silent || (s._pending[e] = !0))
                      : (delete s.changed[e], delete s._pending[e]);
                }),
            ...
            increment: function (e, n) {
              return (
                (h.isUndefined(n) || h.isNull(n)) && (n = 1),
            ...
            revert: function (t) {
              var e = h.last(this._opSetQueue);
              return (
                m(t || h.keys(e)).forEach(function (t) {
                  delete e[t];
                }),
                this._rebuildAllEstimatedData(),
                this
              ...
              return _("classes", this.className, this.id, "GET", g(t), e).then(
                function (e) {
                  ...
                  return (
                    n._cleanupUnsetKeys(
                      r,
                      t.keys ? m(t.keys).join(",").split(",") : void 0,
                    ),
                    n._finishFetch(r, !0),
                    n
                  );
            ...
            save: function (e, n, r) {
              ...
              h.isObject(e) || y(e)
                ...
                : ((i = {}), (i[e] = n), (s = r)),
                (s = h.clone(s) || {}),
                s.wait && (o = h.clone(this.attributes));
              var a = h.clone(s) || {};
              ...
              var u = this,
                ...
                f = [];
              return (
                t.Object._findUnsavedChildren(u, c, f),
                c.length + f.length > 1
                  ? t.Object._deepSaveAsync(this, u, s)
                  : (this._startSave(),
                    (this._saving = (this._saving || 0) + 1),
                    (this._allPreviousSaves =
                      this._allPreviousSaves || d.default.resolve()),
                    (this._allPreviousSaves = this._allPreviousSaves
                      ...
                      .then(function () {
                        var t = u.id ? "PUT" : "POST",
                          ...
                          n = {};
                        if (
                          ((u._fetchWhenSave || s.fetchWhenSave) &&
                            (n.new = "true"),
                          ...
                          var r;
                          if (
                            ("function" == typeof s.query._getParams &&
                              (r = s.query._getParams()) &&
                              (n.where = r.where),
                            !n.where)
                          ) {
            ...
            change: function (e) {
              ...
              for (
                ...
                !h.isEmpty(this._pending);

              )
                (this._pending = {}),
                  this.trigger("change", this, e),
                  t._objectEach(this.changed, o),
                  (r._previousAttributes = h.clone(this.attributes));
            ...
            validate: function (e) {
              if (h.has(e, "ACL") && !(e.ACL instanceof t.ACL))
                throw new p(p.OTHER_CAUSE, "ACL must be a AV.ACL.");
            },
            _validate: function (t, e) {
              !e.silent &&
                this.validate &&
                ((t = h.extend({}, this.attributes, t)), this.validate(t));
            },
            getACL: function () {
              return this.get("ACL");
            },
          ...
          (t.Object.extend = function (e, n, r) {
            ...
            return (
              (i.extend = function (n) {
                if (h.isString(n) || (n && h.has(n, "className")))
              ...
              .then(function () {
                return A(
                  ...
                  function () {
                    ...
                    var i = d.default.resolve(
                        h.map(e, function (t) {
                          return t._allPreviousSaves || d.default.resolve();
                        }),
                      ),
                      o = i.then(function () {
                        return _(
        ...
        y = function () {
          ...
          return function (e, n) {
            var r =
              ...
              a = void 0 !== s && s;
            if ("string" != typeof n)
              throw new d(d.OTHER_CAUSE, "unionId is not a string");
            if ("string" != typeof o)
              throw new d(d.OTHER_CAUSE, "unionIdPlatform is not a string");
            return f.extend({}, e, {
              platform: o,
              unionid: n,
          ...
          "_User",
          {
            ...
            _handleSaveResult: function (e) {
              return (
                ...
                (!e && !this.isCurrent()) || t._config.disableCurrentUser
                  ? c.default.resolve()
                  : c.default.resolve(t.User._saveCurrentUser(this))
              );
            },
            ...
            associateWithQQAppWithUnionId: function (e) {
              var n = this,
                ...
                s = r.asMainAccount,
                a = void 0 !== s && s;
              return b("getAuthInfo")({ platform: o }).then(function (r) {
                return (
                  (r = t.User.mergeUnionId(r, e, { asMainAccount: a })),
                  (r.provider = "lc_qqapp"),
            ...
            _isLinked: function (t) {
              var e;
              return (
                (e = f.isString(t) ? t : t.getAuthType()),
                !!(this.get("authData") || {})[e]
              );
            },
            ...
            _logOutWith: function (e) {
              this.isCurrent() &&
                (f.isString(e) && (e = t.User._authProviders[e]),
            ...
            loginWithQQApp: function () {
              ...
              return b("getAuthInfo")({
                ...
                return (
                  (e.provider = "lc_qqapp"),
                  t.loginWithMiniApp(e, { failOnNotExist: c })
                );
              });
            },
            ...
            logIn: function () {
              var t = this;
              return p("login", null, null, "POST", this.toJSON()).then(
                function (e) {
                  var n = t.parse(e);
                  return (
                    t._finishFetch(n),
            ...
            save: function (e, n, r) {
              var i, o;
              return (
                f.isObject(e) || f.isNull(e) || f.isUndefined(e)
                  ? ((i = e), (o = n))
                  : ((i = {}), (i[e] = n), (o = r)),
                (o = o || {}),
          ...
          },
          {
            ...
            requestChangePhoneNumber: function (t, e, n) {
              ...
              return (
                ...
                p("requestChangePhoneNumber", null, null, "POST", r, n)
              );
            },
            ...
            currentAsync: function () {
              return t._config.disableCurrentUser
                ? (console.warn(
                  ...
                  c.default.resolve(null))
                : t.User._currentUser
                  ? c.default.resolve(t.User._currentUser)
        ...
        (t.Query = function (e) {
          ...
          (t.Query.or = function () {
            var e = u.toArray(arguments),
              n = null;
            t._arrayEach(e, function (t) {
              if ((u.isNull(n) && (n = t.className), n !== t.className))
          ...
          (t.Query.doCloudQuery = function (e, n, r) {
            var i = { cql: e };
            return (
              u.isArray(n) ? (i.pvalues = n) : (r = n),
              d("cloudQuery", null, null, "GET", i, r).then(function (e) {
          ...
          u.extend(t.Query.prototype, {
            ...
            get: function (t, e) {
              ...
              if ("" === t)
                return a.default.reject(
                  new f(f.OBJECT_NOT_FOUND, "Object not found."),
                );
              ...
              return (
                ...
                d("classes", this.className, t, "GET", _(i), e).then(
                  function (t) {
                    if (u.isEmpty(t))
                      throw new f(f.OBJECT_NOT_FOUND, "Object not found.");
            ...
            _createRequest: function () {
              ...
              return h({ method: "GET", path: n, query: t, authOptions: e });
            },
                        ...
                        : e.length > 1
                          ...
                          : f || 0 === e.length
                            ? d(
                                ...
                                .then(function (t) {
                                  return t.length || (l = !0), e.concat(t);
                                })
                            : ((l = !0), e);
                    })),
                    s
            ...
            skip: function (t) {
              return (
                y(t, "undefined is not a valid skip value"),
                (this._skip = t),
                this
              );
            },
            limit: function (t) {
              return (
                y(t, "undefined is not a valid limit value"),
                (this._limit = t),
                this
              );
            },
            equalTo: function (e, n) {
              return (
                y(e, "undefined is not a valid key"),
                y(n, "undefined is not a valid value"),
            ...
            _addCondition: function (e, n, r) {
              return (
                y(e, "undefined is not a valid condition key"),
                y(n, "undefined is not a valid condition"),
                y(r, "undefined is not a valid condition value"),
            ...
            ascending: function (t) {
              return (
                y(t, "undefined is not a valid key"), (this._order = t), this
              );
            },
            addAscending: function (t) {
              return (
                y(t, "undefined is not a valid key"),
        ...
        (t.Cloud = t.Cloud || {}),
          o.extend(t.Cloud, {
            ...
            _requestCaptcha: function (t, e) {
              return a("requestCaptcha", null, null, "GET", t, e).then(
                function (t) {
                  var e = t.captcha_url;
      ...
      t.exports = function (t) {
        var e = function () {
            var e =
              arguments.length > 0 && void 0 !== arguments[0]
                ...
                : {};
            return l(e)
              ? t.User._fetchUserBySessionToken(l(e))
              : t.User.currentAsync();
          },
          n = function (n) {
        ...
        (t.Status = function (t, e) {
          return (
            ...
            (this.query = null),
            t && "object" === (void 0 === t ? "undefined" : (0, a.default)(t))
              ? (this.data = t)
          ...
          u.extend(t.Status.prototype, {
            ...
            destroy: function (t) {
              return this.id
                ? c("statuses", null, this.id, "DELETE", t)
                : o.default.reject(new Error("The status id is not exists."));
            },
            toObject: function () {
              return this.id
        ...
        (t.SearchSortBuilder = function () {
          ...
          (t.SearchQuery = t.Query._extend({
            ...
            highlights: function (t) {
              var e;
              return (
                (e = t && o.isString(t) ? o.toArray(arguments) : t),
                (this._highlights = e),
                this
              );
            },
          ...
          o.extend(t.Insight.JobQuery.prototype, {
            ...
            find: function (t) {
              ...
              return u({
                ...
                return t.error
                  ? i.default.reject(new s(t.code, t.error))
                  : i.default.resolve(t);
              });
            },
          });
        ...
        (d.Leaderboard.getStatistics = function (t) {
          ...
          return o.default.resolve().then(function () {
            ...
            return u({
              ...
              query: { statistics: n ? f(n).join(",") : void 0 },
              authOptions: r,
            }).then(function (t) {
    ...
    function (t, e, n) {
      ...
      (e.request = function (t, e) {
        ...
        var n = e.method,
          ...
          c = e.onprogress,
          f = e.signal;
        if (null === f || void 0 === f ? void 0 : f.aborted)
          return Promise.reject(new i.AbortError("Request aborted"));
        var l = o(s, t);
        return (
          u && l.set(u),
          c && l.on("progress", c),
          new Promise(function (t, e) {
            ...
            null === f || void 0 === f || f.addEventListener("abort", n),
              l
                .send(a)
                .then(function (e) {
                  return t(r(e));
        ...
        (e.upload = function (t, e, n) {
          ...
          var s = n.method,
            ...
            f = n.onprogress,
            l = n.signal;
          if (null === l || void 0 === l ? void 0 : l.aborted)
            return Promise.reject(new i.AbortError("Request aborted"));
          ...
          return (
            ...
            new Promise(function (t, e) {
              ...
              null === l || void 0 === l || l.addEventListener("abort", n),
                d
                  .then(function (e) {
                    return t(r(e));
                  })
...
***************************************************************************** */
        ...
        return (i =
          ...
          "symbol" === (0, y.default)(_.default)
            ...
            : function (t) {
                return t &&
                  "function" == typeof g.default &&
                  t.constructor === g.default &&
                  t !== g.default.prototype
                  ? "symbol"
                  : void 0 === t
                    ? "undefined"
                    : (0, y.default)(t);
          ...
          if (Array.isArray(n))
            ...
            for (var r in n)
              Object.prototype.hasOwnProperty.call(n, r) &&
                a(t, "".concat(e, "[").concat(r, "]"), n[r]);
          else t.push(encodeURI(e) + "=" + encodeURIComponent(n));
        }
      }
      function u(t) {
        for (
          var e, n, r = {}, i = t.split("&"), o = 0, s = i.length;
          o < s;
          ++o
        )
          (e = i[o]),
      ...
      (C.serializeObject = s),
        ...
        (l.prototype._parseBody = function (t) {
          ...
          return this.req._parser
            ...
            : (!e && f(this.type) && (e = C.parse["application/json"]),
        ...
        (d.prototype.query = function (t) {
          return (
            "string" != typeof t && (t = s(t)), t && this._query.push(t), this
          );
        }),
        ...
        (d.prototype._isHost = function (t) {
          return (
            t &&
            "object" === i(t) &&
            !Array.isArray(t) &&
        ...
        (d.prototype._end = function () {
          ...
          if (
            ...
            !o && f(i) && (o = C.serialize["application/json"]),
              o && (n = o(n));
          }
          ...
          for (o = 0; o < n.length; o++)
            if (n[o] === t) {
              ...
              return void (void 0 !== s.get
                ? s.configurable
                  ? (Object.defineProperty(i, e, { value: "[Circular]" }),
                    u.push([i, e, t, s]))
                  : c.push([t, e])
                : ((i[e] = "[Circular]"), u.push([i, e, t])));
            }
          ...
          for (o = 0; o < n.length; o++)
            if (n[o] === t) {
              ...
              return void (void 0 !== a.get
                ? a.configurable
                  ? (Object.defineProperty(r, e, { value: "[Circular]" }),
                    u.push([r, e, t, a]))
                  : c.push([t, e])
                : ((r[e] = "[Circular]"), u.push([r, e, t])));
            }
        ...
        (o.prototype._auth = function (t, e, n, r) {
          switch (n.type) {
            case "basic":
              this.set(
                "Authorization",
                "Basic ".concat(r("".concat(t, ":").concat(e))),
              );
              break;
            case "auto":
    ...
    function (t, e, n) {
      ...
      function a(t) {
        if (void 0 !== p.default && (0, d.default)(Object(t)))
    ...
    function (t, e, n) {
      t.exports = { default: n(349), __esModule: !0 };
    },
    function (t, e, n) {
        ...
        "Array",
        {
          from: function (t) {
            ...
            if (
              ...
              for (e = u(d.length), n = new h(e); e > b; b++)
                c(n, b, _ ? v(d[b], b) : d[b]);
            else
              for (l = y.call(d), n = new h(); !(i = l.next()).done; b++)
                c(n, b, _ ? s(l, v, [i.value, b], !0) : i.value);
            return (n.length = b), n;
          },
        },
      );
