    ...
    function (e, t, n) {
      ...
      function l(e, t, n, r) {
        if (((n = v(n)), "href" === t || "src" === t)) {
          ...
          if (((T.lastIndex = 0), T.test(n) && ((j.lastIndex = 0), j.test(n))))
            return "";
          ...
          try {
            ...
            (0, y.default)(e.cfg, function (t) {
              ...
              !(function t(n) {
                ...
                o && $.add(AV.Object.extend("Counter"), e.cfg.path),
                e.$el && e.bind();
            });
          } catch (t) {
      ...
      (i.prototype.Q = function (e) {
        ...
        (i.prototype.bind = function () {
            ...
            c = function (e) {
              ...
              t.html(n.join("")),
                ...
                t.find("i").on("click", function (e) {
                  e.preventDefault(),
                    D(o[0], " :" + (0, A.default)(this).attr("title") + ":");
                });
            };
          (e.$emoji = {
            show: function () {
          ...
          e.Q(e.cfg.path)
            ...
            .then(function (t) {
              t > 0
                ? (e.$el.find(".vcount").show().find(".vnum").text(t), F())
                : e.$loading.hide();
            })
            .catch(function (t) {
              ...
              var s = t.get("link")
                ...
                f = B.hide
                  ...
                  : e.cfg.enableQQ && t.get("QQAvatar")
                    ? '<img class="vimg" src="' +
                      (0, C.default)(t.get("QQAvatar")) +
                      '" referrerPolicy="no-referrer"/>'
                    : '<img class="vimg" src="' +
                      (B.cdn + (0, u.default)(t.get("mail")) + B.params) +
                      '">',
                p =
                  f +
          ...
          z.on("click", P),
            (0, A.default)(document)
              .on("keydown", function (e) {
                ...
                ((e.ctrlKey || e.metaKey) && 13 === t && P(), 9 === t) &&
                  "veditor" == (document.activeElement.id || "") &&
                  (e.preventDefault(), D(o[0], "    "));
              })
              .on("paste", function (e) {
                var t =
                  "clipboardData" in e
            ...
            o.on("dragenter dragleave dragover drop", function (e) {
              e.stopPropagation(),
                e.preventDefault(),
                "drop" === e.type && L(e.dataTransfer.items);
            });
          var L = function (e, t) {
                  ...
                  U(a, function (s) {
                    500 != s.code
                      ? (o.val(
                        ...
                        (0, l.default)(o[0]),
                        ++r < i ? t(n, r) : z.removeAttr("disabled"))
                      : (o.val(o.val().replace(u, "")),
                        (0, l.default)(o[0]),
                        e.$el.find(".status-bar").text(s.msg).empty(3e3),
                        z.removeAttr("disabled"));
                  });
              }
            },
      ...
      function i(e, t) {
        ...
        function g(e, n) {
          var r,
            i = 0,
            o = a(n);
          if (o) for (i = y.length - 1; i >= 0 && y[i] !== o; i--);
          if (i >= 0) {
        ...
        function r(e, t, r) {
          function u(e) {
            ...
            "class" === d && -1 === p.indexOf(d)
              ? ((c = c.split(" ").filter(r).join(" ").trim()), (u = c.length))
              : (u = -1 !== p.indexOf(d) && (!0 !== a.uris[d] || l(c))),
              u &&
                (n(" "),
                n(e),
                "string" == typeof c && (n('="'), n(i.encode(c)), n('"')));
          }
          var s = o(e);
          return h.ignoring
            ? void f(s)
            : -1 === (v.allowedTags || []).indexOf(s)
              ? void f(s)
              : v.filter && !v.filter({ tag: s, attrs: t })
                ? void f(s)
                : (n("<"),
                  n(s),
      ...
      e.exports = function e(t, n, F, T) {
        function I(t, n, r) {
          if ((n && ((T = oe.call(T)), T.push(n)), r)) {
            var i = { depth: R.depth };
            return (
              v(R, "quoteStyle") && (i.quoteStyle = R.quoteStyle),
              e(t, i, F + 1, T)
            );
          }
          return e(t, R, F + 1, T);
        ...
        if (k(t)) {
          for (
            ...
            J += " " + ee[ne].name + "=" + i(o(ee[ne].value), "double", R);
          return (
            (J += ">"),
